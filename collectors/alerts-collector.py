...
def get_paths(now):
    ...
    file_folder_path = os.path.join(BASE, date_folder, "alerts")
    os.makedirs(file_folder_path, exist_ok=True)
    filename = now.strftime("alerts_%Y-%m-%d_%H.jsonl")
    file_path = os.path.join(file_folder_path, filename)

    log_folder = os.path.join(BASE, date_folder)
    os.makedirs(log_folder, exist_ok=True)
    log_path = os.path.join(log_folder, f"alerts-{date_folder}.log")
